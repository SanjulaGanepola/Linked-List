...
public class Patient implements Comparable {
    ...
    /**
     * Method to return the patient data as a String. Returns the data of the patient
     * as a String.
     ...
     * @return Negative integer if priority is lower, zero if priority is the same and a positive number if priority is higher
     */
    @Override
